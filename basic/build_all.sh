...
echo ...
echo "icc -O2 -xAVX -qopt-report=3 -qopt-report-phase=vec pi.c fx.c -o AVX_pi_c"
icc -O2 -xHost -qopt-report=3 -qopt-report-phase=vec pi.c fx.c -o xHost_pi_c
echo ...
echo "icc -O2 -xAVX -qopt-report=3 -qopt-report-phase=vec pi.c fx.c -o AVX_pi_c"
...
echo ...
echo "icc -O2 -parallel -ipo -qopt-report:3 -qopt-report-phase=par pi.c fx.c -o par_ipo_pi_c"
icc -O2 -parallel -ipo -qopt-report:3 -qopt-report-phase=par pi.c fx.c -o par_ipo_pi_c
